...
This is where the supporting code and quantum chemistry calculation result files for the paper "Highly generalizable model with cascaded feature engineering: toward small datasets" is stored

The deep learning framework we use is tensorflow_gpu 2.10.0 under Windows system
